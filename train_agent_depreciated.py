...
# How many raw env steps pass between each perception+decision. Higher =
# faster training (fewer expensive network calls), lower = more
# responsive control.
DECISION_INTERVAL = 4
...
def run_episode(env, eye, central_layer, readout, episode_number):
...
def main():
    ...
    for episode in range(1, NUM_EPISODES + 1):
        ...
        log_probs, rewards, score = run_episode(env, eye, central_layer, readout, episode)
